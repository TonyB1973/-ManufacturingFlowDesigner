...
assert(migrated.migratedFrom === '1.5.0' && migrated.document.schemaVersion === '1.8.0' && migrated.document.settings.standardWork.timeFormat === 'minutesSeconds' && migrated.document.settings.standardWork.chart.showAutomaticLanes, 'Schema 1.5 migrates explicitly to takt-capable chart settings while preserving Standard Work data');
