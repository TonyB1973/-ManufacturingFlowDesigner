...
assert(migrated.migratedFrom === '1.5.0' && migrated.document.schemaVersion === '1.9.0' && migrated.document.settings.standardWork.timeFormat === 'minutesSeconds' && migrated.document.settings.standardWork.chart.showAutomaticLanes, 'Schema 1.5 migrates explicitly to availability-capable chart settings while preserving Standard Work data');
