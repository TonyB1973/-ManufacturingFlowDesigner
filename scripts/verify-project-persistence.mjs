...
assert(migrated.migratedFrom === '0.9.0' && migrated.document.schemaVersion === '1.6.0', 'Registered older schema migrations chain into the current schema');
