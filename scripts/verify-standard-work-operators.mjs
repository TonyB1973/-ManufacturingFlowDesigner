...
const planning = new StandardWorkPlanningStore((id) => Boolean(standardWork.getStudy(id)));
...
const context = { resources, operations, connections, structure: {}, routes: emptyRoutes, annotations: emptyAnnotations, standardWork, standardWorkOperators: operators, standardWorkHandovers: handovers, standardWorkPlanning: planning, standardWorkSelection, project, selection: canvasSelection };
