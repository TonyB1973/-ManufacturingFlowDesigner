...
export function createAppShell(): AppShellResult {
  ...
  const standardWorkSelection = new StandardWorkSelectionStore(); const availabilitySelection = new AvailabilitySelectionStore(); const standardWorkStore = new StandardWorkStore(new StandardWorkStudyIdGenerator(), new StandardWorkEntryIdGenerator(), (id) => Boolean(operationStore.getOperation(id)));
