...
export const revealStandardWork = (kind: 'standardWorkStudy' | 'standardWorkEntry', id: string): void => { document.dispatchEvent(new CustomEvent(STANDARD_WORK_REVEAL_EVENT, { detail: { kind, id } })); };
