import type { CanvasWorkspaceId, WorkspaceId, WorkspaceViewportState } from '../models/workspace/Workspace';
...
export class WorkspaceStore {
  ...
  private readonly viewports: Record<CanvasWorkspaceId, WorkspaceViewportState> = { processFlow: initialViewport(), factoryLayout: initialViewport() };
  ...
  public getViewport(workspace: CanvasWorkspaceId): WorkspaceViewportState { return { ...this.viewports[workspace] }; }
  public updateViewport(workspace: CanvasWorkspaceId, patch: Partial<WorkspaceViewportState>): void { Object.assign(this.viewports[workspace], patch); }
