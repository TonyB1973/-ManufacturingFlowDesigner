    ...
    for (const group of RIBBON_TABS[index].groups) {
      ...
      for (const command of group.commands) {
        ...
        button.addEventListener('click', () => {
          ...
          else if (command === 'Availability') workspaceStore?.activate('availability');
