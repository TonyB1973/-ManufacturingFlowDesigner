...
export class OperationInteractionController {
  ...
  public constructor(private readonly viewport: HTMLElement, private readonly state: CanvasState, private readonly store: OperationStore, private readonly snap: SnapService, private readonly onStatus: (message: string) => void, private readonly commands: CommandFactory) {
